      ...
      <div class="col-lg-7 col-md-7">
        <div class="selectData">
          <BForm class="mx-5 my-3" @submit.prevent="onSubmit" @reset="onReset">
            ...
            <BButton type="submit" pill block variant="success">{{
              $t("selectTxt")
            }}</BButton>
          </BForm>
        </div>
  ...
  data() {
    return {
      places: [
        ...
        "Centre Universitaire Santé McGill",
        "Hôpital Sacré-Coueur de Montréal",
      ...
      sitesOptions: [
        ...
        {
          text: "Centre Hospitalier Universitaire Sainte-Justine",
          value: "CHUSJ",
        },
