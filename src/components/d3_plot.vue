  ...
  methods: {
    d3plot() {
      ...
      rects
        .selectAll("g")
        .data(function (d, i) {
          return d.map((d) => d.concat(i));
        })
        .enter()
        .append("circle")
        .attr(
          "transform",
          (d) => "translate(" + that.getScale(d[2], d[0]) + " -12)",
        )
        ...
        .attr(
          "style",
          "fill-opacity: 0.7; stroke:#525252; stroke-opacity: 0.7;",
        )
